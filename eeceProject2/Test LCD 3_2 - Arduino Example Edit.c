...
#define PIN_SCE   P0_7 //3
#define PIN_RESET P0_6 //4
#define PIN_DC    P0_5 //5
#define PIN_SDIN  P0_4 //6
#define PIN_SCLK  P0_3 //7
...
void ClockIrqHandler (void) interrupt 1 using 1
{
	...
	cnt++;
	if(cnt>1) //XXXms for half a period; 0.0 to 4.0Mbits/sec
	{
		P0_3=!P0_3;
		cnt=0;
	}
...
void LcdWrite(unsigned char dc, unsigned char datay)
{
  PIN_DC = dc;
  PIN_SCE = 0;
  //shiftOut(PIN_SDIN, PIN_SCLK, MSBFIRST, datay);
  printf("stuck in LCD write");
  ShiftOutByte(datay);
  PIN_SCE = 1;
}
...
void ShiftOutByte( unsigned char Data )
{
    ...
    {
        while(PIN_SCLK == 1);
        printf("stuck in shift\n");
        while(PIN_SCLK == 0);
        printf("stuck in shift2\n");
        PIN_SDIN = Data & 1;
        Data >>= 1;
    } 
